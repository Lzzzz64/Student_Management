                ...
                <el-main>
                    <el-form :inline="true" :model="searchForm" class="demo-form-inline">
                        <el-form-item label="学号：">
                            <el-input v-model="searchForm.sno" placeholder="学号"></el-input>
                        </el-form-item>
                        <el-form-item label="姓名：">
                            <el-input v-model="searchForm.sn" placeholder="姓名"></el-input>
                        </el-form-item>
                        <el-form-item>
                    ...
                    <el-table :data="tableData">
                        ...
                        <el-table-column prop="sn" label="姓名" width="160">
                        </el-table-column>
                        <el-table-column prop="gender" label="性别" width="150">
                        </el-table-column>
                        <el-table-column prop="maj" label="专业班级" width="250">
                        </el-table-column>
                        <el-table-column prop="address" label="宿舍地址" width="250">
                        </el-table-column>
                    ...
                    <!-- 添加信息框 -->
                    <el-dialog title="添加学生信息" :visible.sync="dialogFormVisible_add">
                        <el-form :ref="form" model="form">
                            ...
                            <el-form-item label="专业班级">
                                <el-input v-model="form.maj"></el-input>
                            </el-form-item>
...
export default {
    ...
    methods: {
        ...
        //添加信息
        handleAdd() {
            axios.post("/api/admin/student", this.form).then(res => {
                if (res.data.code == "1") {
        ...
        // 提交修改过后的数据
        handleUpdate() {
            axios.put("/api/admin/student/update", this.form).then(res =>  {
                if (res.data.code == "1") {
        ...
        //删除
        handleDelete(index) {
            var sno_ = this.tableData[index].sno;
            axios.delete("/api/admin/student?sno=" + sno_).then(() => {
        ...
        // 分页获取数据
        fetchData() {
            axios.get("/api/admin/student/page", {
                params: {
